...
void APPE_Button2Action(void)
{
  ...
  {
    UTIL_SEQ_SetTask( 1<<CFG_TASK_SEND_NOTIF_EXT_ID, CFG_SEQ_PRIO_0);
  }
...
void APPE_Button3Action(void)
{
  ...
  {
    /* GATT Exchange - ATT MTU */
    aci_gatt_exchange_config(bleAppContext.BleApplicationContext_legacy.connectionHandle);
  }
